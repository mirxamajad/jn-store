                ...
                <div class="sidebar">
                    <div class="product-widget">
                        ...
                        <ul class="product-categories">
                            @foreach ($cat as $key)
                                @foreach ($key->childcategory as $subcat)
                                    <li>
                                        <a href="{{ route('index.allchildproduct', ['subcate'=>$key->slug,'id'=>$subcat->id,'slug'=>$subcat->slug]) }}">
                                            {{$subcat->name}}
                                        </a>
                                    </li>
                                @endforeach
                                                        ...
                                                        <div class="product__thumb">
                                                            ...
                                                            <div class="product-info mb-10">
                                                                ...
                                                                <div class="pro-price">
                                                                    ...
                                                                    <a class="p-absoulute pr-2" href="#"><button class="btn btn-default p-absoulute pr-2 addToCart" data-id="{{ route('add.to.cart', $product->id) }}">add to cart</button></a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="product product-4">
                                                        <div class="product__thumb">
                                                            ...
                                                            <div class="product-info mb-10">
                                                                ...
                                                                <div class="pro-price">
                                                                    <p class="p-absoulute pr-1"><span>$</span>{{$product->price}} </p>
                                                                    <button class="btn btn-default p-absoulute pr-2 addToCart" data-id="{{ route('add.to.cart', $product->id) }}">add to cart</button>
                                                                </div>
                                                            </div>
                                                        <div class="product__action">
                                                        {{-- <div class="inner__action">
